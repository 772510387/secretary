...
export const FIXED_CEREBELLUM_ALARM_RULES: readonly CerebellumAlarmRule[] = [
  ...
  fixedAlarm({
    alarmId: "weekend-morning-brief-sat",
    alarmType: "weekend_morning_brief",
    beijingTime: "08:30",
    frequency: "weekly",
    priority: 27,
    brainTaskType: "daily_reflection",
    weekdaysOnly: false,
    dayOfWeek: 6,
    description: "Saturday 08:30 Beijing weekend morning brief task.",
  }),
  fixedAlarm({
    alarmId: "weekend-morning-brief-sun",
    alarmType: "weekend_morning_brief",
    beijingTime: "08:30",
    frequency: "weekly",
    priority: 28,
    ...
    weekdaysOnly: false,
    dayOfWeek: 7,
    description: "Sunday 08:30 Beijing weekend morning brief task.",
  }),
  fixedAlarm({
    alarmId: "weekly-knowledge-absorb-sat",
    alarmType: "weekly_knowledge_absorb",
    beijingTime: "14:00",
    frequency: "weekly",
    priority: 29,
    brainTaskType: "daily_reflection",
    weekdaysOnly: false,
    dayOfWeek: 6,
    description: "Saturday 14:00 Beijing knowledge absorption task.",
  }),
  fixedAlarm({
    alarmId: "weekly-knowledge-absorb-sun",
    alarmType: "weekly_knowledge_absorb",
    beijingTime: "14:00",
    frequency: "weekly",
    priority: 30,
    ...
    weekdaysOnly: false,
    dayOfWeek: 7,
    description: "Sunday 14:00 Beijing knowledge absorption task.",
  }),
  fixedAlarm({
    alarmId: "weekly-live-report",
    alarmType: "weekly_live_report",
    beijingTime: "15:30",
    frequency: "weekly",
    priority: 31,
    brainTaskType: "daily_reflection",
    weekdaysOnly: false,
    dayOfWeek: 6,
    description: "Saturday 15:30 Beijing weekly paper-trading report task.",
  }),
  fixedAlarm({
    alarmId: "weekly-winrate-review",
    alarmType: "weekly_winrate_review",
    beijingTime: "16:00",
    frequency: "weekly",
    priority: 32,
    brainTaskType: "daily_reflection",
    weekdaysOnly: false,
    dayOfWeek: 6,
    description: "Saturday 16:00 Beijing trading-system win-rate review task.",
  }),
