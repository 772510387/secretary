...
| PRE-07 一字板/封单 | 🔴 | 部分 | 🟡 涨停/topGainers 已由 theme-heat 提供;**封单金额/封单王 无数据源,仍缺**(未编造) |
| MID-01 3秒哨兵 | 🟢 | 确认 | 🟢 保持 |
...
| MEM-05 记忆读写工具进agent | 🔴 | **留待你定** | 🔴 特性而非bug,需护栏设计(大脑可写哪些记忆),未夜间盲上 |
| MEM-06 语义/向量检索 | 🔴 | 改文档 | 🔴 ADR 故意不做,保持关键词;文档 L290 宣称作废 |
| MEM-07 检索引擎接线 | 🟠 | **留待你定** | 🟠 需先定运行态消费者(对话查询工具),未盲接 |

**计**:✅ 14 条落地并测试 · 🟢 5 条保持/确认 · 🟡 5 条保现状+改文档(已注明取舍) · 🔴 2 条(MEM-05/07)留待你定 · 1 条(PRE-07)封单缺数据源。
